...
public class OpenExchangeApiConnection implements CurrencyApiProvider {
    ...
    @Override
    public StringBuilder getCurrencyHistory(String base, LocalDate start, LocalDate end, String symbol) throws IOException {
    ...
    @Override
    public StringBuilder getSymbolsWithSignification() throws IOException {
        String url = openUrl + "/currencies.json?app_id=" + openKey;
        return fetch(url);
    }

    private StringBuilder fetch(String urlStr) throws IOException {
